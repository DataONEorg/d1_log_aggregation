...
public class MNCommunication extends org.dataone.cn.batch.logging.v1.MNCommunication {
    ...
    /**
     * performs the retrieval of the log records from a DataONE node. It retrieves the list in batches and should be
     * called iteratively until all log entries have been retrieved from a node.
     *
     * @param logQueryStack
     *
     ...
     */
    @Override
    public List<LogEntrySolrItem> harvest(Stack<LogQueryDateRange> logQueryStack, Integer queryTotalLimit)
