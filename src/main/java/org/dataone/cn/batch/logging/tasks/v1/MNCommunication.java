...
public class MNCommunication extends NodeCommunication {
     ...
     */
	@Override
    public List<org.dataone.service.types.v2.LogEntry> retrieve(NodeReference d1NodeReference, Stack<LogQueryDateRange> logQueryStack, Integer queryTotalLimit) 
    		throws Exception {
